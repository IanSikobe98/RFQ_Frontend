      ...
      <div class="modal-body">
        <div class="row g-4">
          ...
          <div class="col-md-6">
            ...
            <select class="form-select" v-model="selectedAccount">
          ...
          <div class="col-md-6">
            ...
            <input class="form-control"  placeholder="Enter Negotiated Rate" />
          </div>
          ...
          <div class="col-md-6">
            <div class="rate-box" >
              ...
              ><Strong>1 {{ rateFrom }} = {{rateValue}} {{rateTo}}</Strong></p>
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="totals-box">
              <p>Expected Total</p>
              <p><strong style="font-size:30px; color: forestgreen">{{expectedValue}} {{rateTo}}</strong></p>
            </div>
          </div>
...
<!--          </div>-->
      ...
      <div class="modal-footer" style="gap: 1rem">
        <button class="btn btn-outline-success px-4" @click="showCreateRFQModal = false">
          Cancel
        </button>
