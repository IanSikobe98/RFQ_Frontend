        ...
        <div class="form-card">
          ...
          <div class="form-card-header">
            <div class="header-content">
              ...
              <div>
                <h4 class="form-title">Update User</h4>
                <p class="form-subtitle">Modify user information and permissions</p>
              </div>
            </div>
          ...
          <div class="form-card-body">
            <form @submit.prevent="editUser">
              ...
              <div class="info-banner">
                ...
                <div class="info-text">
                  <strong>Updating User: {{ userToEdit.username }}</strong>
                  <p>Make changes to the user's information below. All fields are required.</p>
                </div>
              </div>
              ...
              <div class="form-actions">
                <button type="button" class="btn btn-outline" @click="$router.push('/viewUsers')">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                    <path d="M19 12H5M5 12L12 19M5 12L12 5" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                  </svg>
                  <span>Cancel</span>
                </button>
                <button v-if="canUpdateUsers" type="submit" class="btn btn-primary">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
